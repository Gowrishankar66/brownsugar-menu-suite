              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <span
                    ...
                    className={cn(
                      "inline-flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded-full ring-2 ring-background",
                      item.veg_type === "veg" ? "bg-emerald-500" : "bg-rose-500",
                    )}
                  />
                </TooltipTrigger>
                <TooltipContent>
                  {item.veg_type === "veg" ? "Vegetarian" : "Non-Vegetarian"}
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            <h3 className="truncate font-display text-lg leading-tight text-foreground">{item.name}</h3>
          </div>
